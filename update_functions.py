...
def update_parameters_adam(parameters, grads, v, s, t,learning_rate, beta1 = 0.9, beta2 = 0.999 , epsilon = 1e-8):
    ...
    for l in xrange(1,L+1):
        ...
        grads["dW" + str(l)] = grads["dW" + str(l)] - learning_rate*(v_corrected["dW" + str(l)]/np.sqrt(s_corrected["dW" + str(l)] + epsilon))
        grads["db" + str(l)] = grads["db" + str(l)] - learning_rate*(v_corrected["db" + str(l)]/np.sqrt(s_corrected["db" + str(l)] + epsilon))
